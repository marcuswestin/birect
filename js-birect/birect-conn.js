// cd ~/code/allform/go/src/github.com/marcuswestin/birect/js-birect && go run echo-server.go
// cd ~/code/allform/go/src/github.com/marcuswestin/birect/js-birect && t
...
{ // Load wire protobuf
	var fs = require('fs')
	var protobufDefinition = fs.readFileSync(__dirname+'/../proto/wire.proto')
